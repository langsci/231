...
\subtitle{An introduction to semantics and pragmatics\newlineCover
  \textit{\LARGE Second corrected and slightly revised edition}
}

\renewcommand{\lsImpressumCitationText}{%
Kroeger, Paul. 2019. \textit{Analyzing meaning: An introduction to semantics and pragmatics. Second corrected and slightly revised edition}. (Textbooks in Language Sciences~5). Berlin: Language Science Press.
}
...
\BookDOI{10.5281/zenodo.2538330}

\renewcommand{\lsISBNdigital}{978-3-96110-136-8} 
\renewcommand{\lsISBNsoftcover}{978-3-96110-137-5} 
