...
Epistemic: [all $w$: ($w$ is consistent with the available evidence) $\wedge$ (the normal course of events is followed as closely as possible in $w$)] $\text{TRUST}(a,h)$ in $w$\\
Deontic: [all $w$: (the relevant circumstances of the actual world are also true in $w$) $\wedge$ (the relevant authority’s requirements are satisfied as completely as possible in $w$)] $\text{TRUST}(a,h) in w$} \\
