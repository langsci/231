...
\item Because the speaker is the one performing the speech act, performative clauses normally occur in active voice with a first person subject, as in (\ref{ex:10.2}--\ref{ex:10.3}). Passive voice with second or third person subject is also possible with certain verbs; see examples in \REF{ex:10.6}.
